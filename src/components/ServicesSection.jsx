...
const SEO_SERVICE_DETAILS = [
  {
    title: 'Custom Tattoo Design',
    content: `At Gunpoint Tattoo Studio, our custom design service is the pinnacle of personalized body art. We collaborate closely with you to transform your unique ideas into a masterpiece. From initial concept to the final, intricate details, your vision is our blueprint. Experience the best custom tattoos in the region, crafted with passion at <a href="#" class="text-primary hover:underline">Gunpoint Tattoo Studio</a>. Our artists specialize in a wide range of styles, including realism, traditional, geometric, and fine-line, ensuring that your custom tattoo perfectly reflects your individuality. Book a consultation today to start your tattoo journey with us.`,
  },
  {
    title: 'Flash Tattoo',
    content: `Looking for a quick, high-quality piece? Our flash tattoos at Gunpoint Tattoo Studio offer a range of stunning, pre-designed options. Each design is crafted by our talented artists, ensuring you get a stylish and professional tattoo, even on the go. Walk-ins are always welcome for flash tattoos at <a href="#" class="text-primary hover:underline">Gunpoint Tattoo Studio</a>, making it convenient to get beautiful art without a long wait. Discover your next favorite piece from our ever-evolving collection.`,
  },
  {
    title: 'Cover-ups & Reworks',
    content: `Transform your old or unwanted ink with our expert cover-up and rework services. The artists at Gunpoint Tattoo Studio specialize in breathing new life into existing tattoos, seamlessly integrating new designs or correcting previous work. Trust <a href="#" class="text-primary hover:underline">Gunpoint Tattoo Studio</a> to give your tattoo a second chance, turning a faded memory into a vibrant new statement. Our consultation process ensures we understand your goals and deliver a result you'll love.`,
  },
  {
    title: 'Piercing & Jewelry',
    content: `Gunpoint Tattoo Studio offers professional and sterile body piercing services. Our expert piercers use top-of-the-line equipment and techniques to ensure a safe and comfortable experience. We also offer a wide selection of high-quality, hypoallergenic jewelry to complement your new piercing. For all your piercing needs, visit <a href="#" class="text-primary hover:underline">Gunpoint Tattoo Studio</a>. Our commitment to hygiene and precision guarantees a fantastic piercing experience.`,
  },
];
